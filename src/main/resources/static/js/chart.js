$(function() {
    ...
    var dataChartAccessaryType= [];
    var labelChartAccessaryType = [];

    for(var i=0;i<vm.chartAccessaryTypeVMS.length;i++) {
        dataChartAccessaryType.push(vm.chartAccessaryTypeVMS[i].value);
    ...
    var doughnutPieData = {
        ...
        labels: labelChartAccessaryType
    };
